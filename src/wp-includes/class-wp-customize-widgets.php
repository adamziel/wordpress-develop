...
final class WP_Customize_Widgets {
	...
	public function override_sidebars_widgets_for_theme_switch() {
		...
		// recover_lost_widgets() looks at the global $sidebars_widgets.
		$sidebars_widgets = $this->old_sidebars_widgets;
		$sidebars_widgets = recover_lost_widgets( 'customize' );
	 ...
	 * to supply initial $sidebars_widgets before they were overridden by recover_lost_widgets().
	 ...
	 *
	 * When switching themes, the recover_lost_widgets() function is run when the Customizer initializes,
